...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('branches', function (Blueprint $table) {
            ...
            $table->string('logo')->nullable()->after('email');              // path logo toko
            $table->string('bank_name')->nullable()->after('logo');          // nama bank
            $table->string('bank_account')->nullable()->after('bank_name');  // nomor rekening
            $table->string('bank_holder')->nullable()->after('bank_account');// atas nama rekening
            $table->string('tax_id')->nullable()->after('bank_holder');      // NPWP
            $table->text('notes')->nullable()->after('tax_id');              // catatan internal
        });
        ...
        Schema::table('billings', function (Blueprint $table) {
            $table->foreignId('package_id')->nullable()
                ...
                ->nullOnDelete();
            $table->string('period_start')->nullable()->after('billing_date'); // periode mulai
            $table->string('period_end')->nullable()->after('period_start');   // periode selesai
            $table->string('payment_method')->nullable()->after('notes');      // transfer, qris, dll
            $table->string('payment_proof')->nullable()->after('payment_method'); // path bukti bayar
        });
        ...
        Schema::table('notifications', function (Blueprint $table) {
            $table->string('image')->nullable()->after('body');         // opsional gambar
            $table->string('action_url')->nullable()->after('image');   // deep link / URL aksi
